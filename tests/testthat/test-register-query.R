...
test_that("We can register to multiple registries", {
  ...
  x <- register("http://cdiac.ornl.gov/ftp/trends/co2/vostok.icecore.co2", registries = c(r1, r2))
  y <- query("http://cdiac.ornl.gov/ftp/trends/co2/vostok.icecore.co2", registries = c(r1, r2))
  ...
  y <- query("http://cdiac.ornl.gov/ftp/trends/co2/vostok.icecore.co2", registries = r1)
  expect_true(dim(y)[1] == 1)
